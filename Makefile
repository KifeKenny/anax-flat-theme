...
# LESS and CSS
LESS 		 	= style.less ligth.less color.less dark.less colorful.less typography_style.less contrast.less framing.less repetition.less textur-opacity-streck.less bilder-wholeScreen.less foto-centrerat-bilder.less
...
upgrade-grid:
	...
	wget --quiet https://github.com/dbwebb-se/design/blob/master/example/grid/fluid/less/grid-flex.less -O grid-flex.less
	wget --quiet https://github.com/dbwebb-se/design/blob/master/example/grid/fluid/less/grid-float.less -O grid-float.less
